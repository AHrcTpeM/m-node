interface BigObject {
  ...
  { cvalue: number | string | undefined | BigObject } | undefined;
}
type BigObj = Record<
  string,
  { cvalue: number | string | undefined | BigObj } | undefined
>;

function summ(a: BigObject) {
  const x = Object.keys(a).map((k) => {
    const elem = a[k];
    if (typeof elem === "undefined") return 2022; // undefined vs 'undefined'
    if (typeof elem.cvalue === "undefined") return 2022;
    if (typeof elem.cvalue === "string") return Number(elem.cvalue) || 2022;
