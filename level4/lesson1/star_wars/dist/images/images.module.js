...
ImagesModule = ImagesModule_1 = __decorate([
    (0, common_1.Module)({
        imports: [(0, common_1.forwardRef)(() => films_module_1.FilmsModule), (0, common_1.forwardRef)(() => people_module_1.PeopleModule), starships_module_1.StarshipsModule, planets_module_1.PlanetsModule, species_module_1.SpeciesModule, vehicles_module_1.VehiclesModule, ImagesModule_1,
